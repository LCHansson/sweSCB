...
test_that(desc=".findData.input",{
  ...
  cat("\n")
  expect_that(.findData.input(type="yesno","Testing 'y'", test_input="y"),is_equivalent_to("y"))
  cat("\n")
  expect_that(.findData.input(type="yesno","Testing 'n'", test_input="n"),is_equivalent_to("n"))
  cat("\n")
  expect_that(.findData.input(type="text","Testing 'MyData1'", test_input="MyData1"),is_equivalent_to("MyData1"))
  expect_that(.findData.input(type="node", testBaseNode, test_input="3"),
              is_equivalent_to("3"))
  cat("\n")
  expect_that(.findData.input(type="node", testBaseNode, test_input="b"),
              is_equivalent_to("b"))
  cat("\n")
  ...
  test_varDF <- list(data.frame(id = as.character(seq(0.5,10,0.5)),
                     ...
                     "testingVärde")
  expect_that(.findData.input(type="alt", input=test_varDF, test_input="10:12, 1 ,3:1, 2"),
